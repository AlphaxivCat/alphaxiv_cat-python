...
class OrganizationsResourceWithRawResponse:
    ...
    def v2(self) -> V2ResourceWithRawResponse:
        return V2ResourceWithRawResponse(self._organizations.v2)
...
class AsyncOrganizationsResourceWithRawResponse:
    ...
    def v2(self) -> AsyncV2ResourceWithRawResponse:
        return AsyncV2ResourceWithRawResponse(self._organizations.v2)
...
class OrganizationsResourceWithStreamingResponse:
    ...
    def v2(self) -> V2ResourceWithStreamingResponse:
        return V2ResourceWithStreamingResponse(self._organizations.v2)
...
class AsyncOrganizationsResourceWithStreamingResponse:
    ...
    def v2(self) -> AsyncV2ResourceWithStreamingResponse:
        return AsyncV2ResourceWithStreamingResponse(self._organizations.v2)
