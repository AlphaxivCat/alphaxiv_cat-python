...
from ...types.retrieve import v1_get_top_papers_params
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    v1_get_top_papers_params.V1GetTopPapersParams,
                ),
            ),
            cast_to=object,
        )
...
class V1ResourceWithRawResponse:
    def __init__(self, v1: V1Resource) -> None:
        ...
        self.get_top_papers = to_raw_response_wrapper(
            v1.get_top_papers,
        )
...
class AsyncV1ResourceWithRawResponse:
    def __init__(self, v1: AsyncV1Resource) -> None:
        ...
        self.get_top_papers = async_to_raw_response_wrapper(
            v1.get_top_papers,
        )
...
class V1ResourceWithStreamingResponse:
    def __init__(self, v1: V1Resource) -> None:
        ...
        self.get_top_papers = to_streamed_response_wrapper(
            v1.get_top_papers,
        )
...
class AsyncV1ResourceWithStreamingResponse:
    def __init__(self, v1: AsyncV1Resource) -> None:
        ...
        self.get_top_papers = async_to_streamed_response_wrapper(
            v1.get_top_papers,
        )
