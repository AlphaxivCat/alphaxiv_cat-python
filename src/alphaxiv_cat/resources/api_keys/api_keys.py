...
class APIKeysResourceWithRawResponse:
    ...
    def v1(self) -> V1ResourceWithRawResponse:
        return V1ResourceWithRawResponse(self._api_keys.v1)
...
class AsyncAPIKeysResourceWithRawResponse:
    ...
    def v1(self) -> AsyncV1ResourceWithRawResponse:
        return AsyncV1ResourceWithRawResponse(self._api_keys.v1)
...
class APIKeysResourceWithStreamingResponse:
    ...
    def v1(self) -> V1ResourceWithStreamingResponse:
        return V1ResourceWithStreamingResponse(self._api_keys.v1)
...
class AsyncAPIKeysResourceWithStreamingResponse:
    ...
    def v1(self) -> AsyncV1ResourceWithStreamingResponse:
        return AsyncV1ResourceWithStreamingResponse(self._api_keys.v1)
