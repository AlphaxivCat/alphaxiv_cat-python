...
class TestTopics:
    ...
    def test_method_list(self, client: AlphaxivCat) -> None:
        topic = client.users.v3.following.topics.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(TopicListResponse, topic, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_list(self, client: AlphaxivCat) -> None:
        response = client.users.v3.following.topics.with_raw_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: AlphaxivCat) -> None:
        with client.users.v3.following.topics.with_streaming_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_list(self, client: AlphaxivCat) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.users.v3.following.topics.with_raw_response.list(
                "",
            )
    ...
    def test_method_toggle(self, client: AlphaxivCat) -> None:
        topic = client.users.v3.following.topics.toggle(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            topic="x",
        )
        assert_matches_type(TopicToggleResponse, topic, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_toggle(self, client: AlphaxivCat) -> None:
        response = client.users.v3.following.topics.with_raw_response.toggle(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            topic="x",
        )
    ...
    def test_streaming_response_toggle(self, client: AlphaxivCat) -> None:
        with client.users.v3.following.topics.with_streaming_response.toggle(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            topic="x",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_toggle(self, client: AlphaxivCat) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.users.v3.following.topics.with_raw_response.toggle(
                id="",
                topic="x",
            )
...
class TestAsyncTopics:
    ...
    async def test_method_list(self, async_client: AsyncAlphaxivCat) -> None:
        topic = await async_client.users.v3.following.topics.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(TopicListResponse, topic, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncAlphaxivCat) -> None:
        response = await async_client.users.v3.following.topics.with_raw_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncAlphaxivCat) -> None:
        async with async_client.users.v3.following.topics.with_streaming_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncAlphaxivCat) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.users.v3.following.topics.with_raw_response.list(
                "",
            )
    ...
    async def test_method_toggle(self, async_client: AsyncAlphaxivCat) -> None:
        topic = await async_client.users.v3.following.topics.toggle(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            topic="x",
        )
        assert_matches_type(TopicToggleResponse, topic, path=["response"])
    ...
    async def test_raw_response_toggle(self, async_client: AsyncAlphaxivCat) -> None:
        response = await async_client.users.v3.following.topics.with_raw_response.toggle(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            topic="x",
        )
    ...
    async def test_streaming_response_toggle(self, async_client: AsyncAlphaxivCat) -> None:
        async with async_client.users.v3.following.topics.with_streaming_response.toggle(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            topic="x",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_toggle(self, async_client: AsyncAlphaxivCat) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.users.v3.following.topics.with_raw_response.toggle(
                id="",
                topic="x",
            )
